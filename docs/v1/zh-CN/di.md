...
在 HttpController 中，这个特性支持 [Request](/api/v1/Request)、
[Response](/api/v1/Response) 和 [Session](/api/v1/Session) 接口。
...
因此它仅支持 [WebSocket](/api/v1/WebSocket) 和 [Session](/api/v1/Session) 接口，
而其他的参数，则可以直接从客户端发送过来。
