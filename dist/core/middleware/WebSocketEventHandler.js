...
const HttpRouteHandler_1 = require("./HttpRouteHandler");
const HttpInitHandler_1 = require("./HttpInitHandler");
function finish(ctrl, info) {
    ...
    HttpInitHandler_1.logRequest(info.time, socket.protocol.toUpperCase(), info.code, info.event);
}
function handleError(err, info, ctrl, method) {
    ...
    HttpRouteHandler_1.handleLog(_err, ctrl, method);
    finish(ctrl, info);
